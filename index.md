...
I also worked at the [Exertion Games Lab](https://exertiongameslab.org/) of [Monash University](https://www.monash.edu/) in 2020 summer as a research intern, with a focus on Leveraging Electrical Muscle Stimulation as an Embodied Memory Support Devic. [Prof. Florian 'Floyd' Mueller](http://floydmueller.com/) will be my advisor of this intern. He is the **General co-Chair of the _CHI 2020_**, which is the **Top 1** academic conference in the field of the Human-Computer Interaction. Meanwhile, I will work with Rakesh Patibanda at the Exertion Games Lab. **My Pleasure!**.
